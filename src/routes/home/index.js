  ...
  onboarded ? (
    <div class="wrap wrap--thin center home lift-children">
      ...
      <aside class="link-panels">
        ...
        <LinkPanel href="/about/" title="About JustNote" variation="rose">
          <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <div class="wrap wrap--thin center home lift-children">
      <div className="mt20 mb20">
        <h2>What's JustNote?</h2>
        <p>JustNote is a private and personal journaling application.</p>
        <p>
          As well as traditional written entries, you can use JustNote to
